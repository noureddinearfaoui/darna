...
router.get("/addDemande/:idUser/:idAction", auth,permit("membre"), demandeCtrl.addDemande);
router.put("/updateStatus/:idP", auth,permit("admin"), demandeCtrl.updateStatus);
router.put("/updateParticipation/:idP", auth,permit("admin","membre"), demandeCtrl.updateParticipation);
router.get(
  "/participationRequestByMember/:userId"
  , auth,permit("admin","membre"),
  demandeCtrl.getParticipationDemandesByMember
);
router.get("/requestsByAction/:idAction", auth,permit("admin"), demandeCtrl.getDemandesByAction);
router.get(
