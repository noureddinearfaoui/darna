...
router.get("/AcceptedMembers", auth,permit("admin"),UserCtrl.getAcceptedMembers);
router.get("/Demandes", auth,permit("admin"), UserCtrl.getDemandes);
router.post("/addMember", auth,permit("admin"), UserCtrl.addMember);
router.post("/addNewAdhesion/:id", auth,permit("admin"), UserCtrl.NouveauAdhsion);
...
router.delete("/deleteMember/:id", auth,permit("admin"), UserCtrl.deleteOneMember);
